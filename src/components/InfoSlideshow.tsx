      ...
      <div className="relative min-h-[520px] md:min-h-[460px]">
        ...
        {slides.map((slide, index) => {
          ...
          return (
            <div
              key={slide.id}
              className={`absolute inset-0 grid transition-opacity duration-700 ease-in-out md:grid-cols-[1.08fr_0.92fr] ${isActive ? "opacity-100 z-10" : "opacity-0 z-0 pointer-events-none"
                }`}
            >
